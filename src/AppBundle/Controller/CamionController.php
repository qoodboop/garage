...
class CamionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $camions = $em->getRepository('AppBundle:Camion')->findAll();
    ...
    {
        $camion = new Camion();
        $form = $this->createForm('AppBundle\Form\CamionType', $camion);
    ...
    {
        $deleteForm = $this->createDeleteForm($camion);
        $editForm = $this->createForm('AppBundle\Form\CamionType', $camion);
